...
const createOne = async(req,res,next)=>{
    try {
        ...
        let response = await createOneServices(productoRecibido)
...
const readAll = async(req,res,next)=>{
    try {
        const { method, originalUrl: url } = req;
        let response = await readAllServices()
...
const readById = async(req,res,next)=>{
    ...
    //validaciones
    try {
        let response=await readByIdServices(pid)
        if(!response){
...
const updateById = async(req,res,next)=>{
    try {
        ...
        let position= await readByIdServices(pid)
        ...
        const response = await updateByIdServices(pid,updatedData)
