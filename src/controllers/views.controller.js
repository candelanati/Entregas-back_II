...
const resetView = async (req, res) => {
 ...
 const resetRequestView = (req, res) => {
  res.render("resetRequest");
};

export {indexView, registerView, loginView, detailsView, profileView, updateUserView, cartView, verifyView,resetView,resetRequestView} //export para usar en views router